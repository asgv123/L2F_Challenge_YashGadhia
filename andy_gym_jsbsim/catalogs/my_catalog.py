...
from andy_gym_jsbsim.catalogs.property import Property
from andy_gym_jsbsim.catalogs.jsbsim_catalog import JsbsimCatalog
from andy_gym_jsbsim.envs.taxi_utils import *
from andy_gym_jsbsim.catalogs import utils
...
class MyCatalog(Property, Enum):
    ...
    def update_da(sim):
        ...
        for i in range(1, len(df) + 1):
            ...
            sim.set_property_value(
                MyCatalog["a" + str(i)],
                utils.reduce_reflex_angle_deg(df[i - 1][2] - sim.get_property_value(JsbsimCatalog.attitude_psi_deg)),
            )
