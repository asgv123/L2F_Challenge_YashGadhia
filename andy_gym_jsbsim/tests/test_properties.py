...
from andy_gym_jsbsim import Catalog as c
from andy_gym_jsbsim.catalogs.utils import reduce_reflex_angle_deg


class TestPropertyUpdates(unittest.TestCase):
    def setUp(self):
        self.env = andy_gym_jsbsim.make("GymJsbsim-HeadingControlTask-v0")
        self.env.reset()
