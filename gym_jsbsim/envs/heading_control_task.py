...
class HeadingControlTask(Task):
    ...
    init_conditions = {
        ...
        c.ic_r_rad_sec: 0,
        c.ic_roc_fpm: 0,
        c.ic_psi_true_deg: 100, #initial heading
    ...
    def is_terminal(self, state, sim):
        ...
        # if bool(sim.get_property_value(c.detect_extreme_state)) == True:
        #     print("TERMINAL XXX")
        
        # if sim.get_property_value(c.position_h_sl_ft) < 3000:
        #     print("TERMINAL HSL")
